package com.nschecker.evaluation;
...
import com.nschecker.classes.TopologyStatus;
import com.nschecker.evaluation.util.OntoNFVUtilTest;
...
public class Experiments {
	...
	public void runExperiment(int num_hosts_per_nfvipop, int num_nfv_services, ArrayList<String> levels_num_vnfcs,
		...
		for (String key : topologies.keySet()) {
			...
			this.ontomanager.startOntologyProcessing(OntoNFVUtilTest.ONTOFILE);
			...
			for (String level_num_vnfcs : levels_num_vnfcs) {
				...
				this.ontomanager = new OntologyManager();
				this.ontomanager.startOntologyProcessing(status.getFile());
